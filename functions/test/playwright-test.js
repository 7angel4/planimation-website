...
(async () => {
    ...
    await page.click(GALLERY_URL);
    // await page.click("[alt='Family-and-fisherman']");
    // await page.click("#planimationMenuItem > a");
    // await page.click("#filesChosenButton");
    // await page.click("[d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z']");
    // await page.click(".MuiSlider-root");
    // await page.click("[d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z']");
    // await page.click("[d='M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z']");
    // await page.click("[d='M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z']");
    // await page.click("._3MfPgPVvFEx5krwdLXMAdU div > :nth-child(5) .MuiSvgIcon-root");
    // await page.click("body > div.gallery > button:nth-child(5)");
    // await page.click("[alt='Depot']");
    // await page.click("#view-source-code");

    // await page.click(".to-references");
    ...
    // await page.click(".to-suggestions");
